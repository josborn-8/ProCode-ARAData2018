...
RAW_BASE_DIR=/data/wipac/ARA/$YEAR/filtered/burnSample1in10/ARA0$STATION/raw_data/
ROOT_BASE_DIR=/data/wipac/ARA/$YEAR/filtered/burnSample1in10/ARA0$STATION/root/
...
EVENT_FILE_LIST=`mktemp event$RUN_NUM.XXXX`
