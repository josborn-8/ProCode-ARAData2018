...
RAW_DIR=/data/wipac/ARA/$YEAR/filtered/unzippedTGZFiles/ARA0$STATION/raw_data_tagged/run_$RUN_FOLDER
OUT_RAW_DIR=/data/wipac/ARA/$YEAR/filtered/unzippedTGZFiles/ARA0$STATION/raw_data
